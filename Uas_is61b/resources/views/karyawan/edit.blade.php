...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="/karyawan/{{$kar->id}}">
            @method('PUT')
            @csrf
            <div class="mb-3">
                <label class="form-label">Kode Karyawan</label>
                <input type="text" value="{{$kar->kode}}" class="form-control" name="kode">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Karyawan</label>
                <input type="text" value="{{$kar->nm_kar}}" class="form-control" name="nm_kar">
            </div>
